      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/solutions/d2c" className="text-gray-600 hover:text-primary transition-colors">
                  For E-commerce & D2C
                </Link>
              </li>
              <li>
                <Link to="/solutions/digital-services" className="text-gray-600 hover:text-primary transition-colors">
